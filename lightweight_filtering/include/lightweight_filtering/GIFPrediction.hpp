...
//    noiP_.llt().solveInPlace(noiPinv_); // TODO: fix and improve
  ...
  {
	std::cout << "do GIF performPrediction: "<< std::endl;  
    mtMeas meas;
    meas.setIdentity();
